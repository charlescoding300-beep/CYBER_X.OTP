...
COUNTRIES = [
    # 🌍 AFRICA (54 countries)
    ("Algeria", "🇩🇿", "+213", (2, 3, 6, 11)),
    ("Angola", "🇦🇴", "+244", (3, 3, 6, 12)),
    ("Benin", "🇧🇯", "+229", (3, 3, 6, 12)),
    ("Botswana", "🇧🇼", "+267", (3, 3, 6, 12)),
    ("Burkina Faso", "🇧🇫", "+226", (3, 3, 6, 12)),
    ("Burundi", "🇧🇮", "+257", (3, 3, 6, 12)),
    ("Cabo Verde", "🇨🇻", "+238", (3, 3, 6, 12)),
    ("Cameroon", "🇨🇲", "+237", (3, 3, 6, 12)),
    ("Central African Rep.", "🇨🇫", "+236", (3, 3, 6, 12)),
    ("Chad", "🇹🇩", "+235", (3, 3, 6, 12)),
    ("Comoros", "🇰🇲", "+269", (3, 3, 6, 12)),
    ("Congo", "🇨🇬", "+242", (3, 3, 6, 12)),
    ("Côte d'Ivoire", "🇨🇮", "+225", (3, 3, 6, 12)),
    ("DR Congo", "🇨🇩", "+243", (3, 3, 6, 12)),
    ("Djibouti", "🇩🇯", "+253", (3, 3, 6, 12)),
    ("Egypt", "🇪🇬", "+20", (2, 3, 7, 12)),
    ("Equatorial Guinea", "🇬🇶", "+240", (3, 3, 6, 12)),
    ("Eritrea", "🇪🇷", "+291", (3, 3, 6, 12)),
    ("Ethiopia", "🇪🇹", "+251", (3, 3, 6, 12)),
    ("Gabon", "🇬🇦", "+241", (3, 3, 6, 12)),
    ("Gambia", "🇬🇲", "+220", (3, 3, 6, 12)),
    ("Ghana", "🇬🇭", "+233", (3, 3, 6, 12)),
    ("Guinea", "🇬🇳", "+224", (3, 3, 6, 12)),
    ("Guinea-Bissau", "🇬🇼", "+245", (3, 3, 6, 12)),
    ("Kenya", "🇰🇪", "+254", (3, 3, 6, 12)),
    ("Lesotho", "🇱🇸", "+266", (3, 3, 6, 12)),
    ("Liberia", "🇱🇷", "+231", (3, 3, 6, 12)),
    ("Libya", "🇱🇾", "+218", (3, 3, 6, 12)),
    ("Madagascar", "🇲🇬", "+261", (3, 3, 6, 12)),
    ("Malawi", "🇲🇼", "+265", (3, 3, 6, 12)),
    ("Mali", "🇲🇱", "+223", (3, 3, 6, 12)),
    ("Mauritania", "🇲🇷", "+222", (3, 3, 6, 12)),
    ("Mauritius", "🇲🇺", "+230", (3, 3, 6, 12)),
    ("Morocco", "🇲🇦", "+212", (3, 3, 6, 12)),
    ("Mozambique", "🇲🇿", "+258", (3, 3, 6, 12)),
    ("Namibia", "🇳🇦", "+264", (3, 3, 6, 12)),
    ("Niger", "🇳🇪", "+227", (3, 3, 6, 12)),
    ("Nigeria", "🇳🇬", "+234", (3, 3, 6, 12)),
    ("Rwanda", "🇷🇼", "+250", (3, 3, 6, 12)),
    ("São Tomé", "🇸🇹", "+239", (3, 3, 6, 12)),
    ("Senegal", "🇸🇳", "+221", (3, 3, 6, 12)),
    ("Seychelles", "🇸🇨", "+248", (3, 3, 6, 12)),
    ("Sierra Leone", "🇸🇱", "+232", (3, 3, 6, 12)),
    ("Somalia", "🇸🇴", "+252", (3, 3, 6, 12)),
    ("South Africa", "🇿🇦", "+27", (2, 3, 6, 11)),
    ("South Sudan", "🇸🇸", "+211", (3, 3, 6, 12)),
    ("Sudan", "🇸🇩", "+249", (3, 3, 6, 12)),
    ("Eswatini", "🇸🇿", "+268", (3, 3, 6, 12)),
    ("Tanzania", "🇹🇿", "+255", (3, 3, 6, 12)),
    ("Togo", "🇹🇬", "+228", (3, 3, 6, 12)),
    ("Tunisia", "🇹🇳", "+216", (3, 3, 6, 12)),
    ("Uganda", "🇺🇬", "+256", (3, 3, 6, 12)),
    ("Zambia", "🇿🇲", "+260", (3, 3, 6, 12)),
    ("Zimbabwe", "🇿🇼", "+263", (3, 3, 6, 12)),
    ("Zanzibar", "🇹🇿", "+255", (3, 3, 6, 12)),

    # 🌍 NORTH AMERICA (23 countries)
    ("Antigua", "🇦🇬", "+1-268", (4, 3, 6, 13)),
    ("Bahamas", "🇧🇸", "+1-242", (4, 3, 6, 13)),
    ("Barbados", "🇧🇧", "+1-246", (4, 3, 6, 13)),
    ("Belize", "🇧🇿", "+501", (3, 3, 6, 12)),
    ("Bermuda", "🇧🇲", "+1-441", (4, 3, 6, 13)),
    ("Canada", "🇨🇦", "+1", (1, 3, 7, 11)),
    ("Costa Rica", "🇨🇷", "+506", (3, 3, 6, 12)),
    ("Cuba", "🇨🇺", "+53", (2, 3, 6, 11)),
    ("Dominica", "🇩🇲", "+1-767", (4, 3, 6, 13)),
    ("Dominican Rep.", "🇩🇴", "+1-809", (4, 3, 6, 13)),
    ("El Salvador", "🇸🇻", "+503", (3, 3, 6, 12)),
    ("Grenada", "🇬🇩", "+1-473", (4, 3, 6, 13)),
    ("Guatemala", "🇬🇹", "+502", (3, 3, 6, 12)),
    ("Haiti", "🇭🇹", "+509", (3, 3, 6, 12)),
    ("Honduras", "🇭🇳", "+504", (3, 3, 6, 12)),
    ("Jamaica", "🇯🇲", "+1-876", (4, 3, 6, 13)),
    ("Mexico", "🇲🇽", "+52", (2, 3, 7, 12)),
    ("Nicaragua", "🇳🇮", "+505", (3, 3, 6, 12)),
    ("Panama", "🇵🇦", "+507", (3, 3, 6, 12)),
    ("Puerto Rico", "🇵🇷", "+1-787", (4, 3, 6, 13)),
    ("St. Kitts", "🇰🇳", "+1-869", (4, 3, 6, 13)),
    ("St. Lucia", "🇱🇨", "+1-758", (4, 3, 6, 13)),
    ("St. Vincent", "🇻🇨", "+1-784", (4, 3, 6, 13)),
    ("Trinidad", "🇹🇹", "+1-868", (4, 3, 6, 13)),
    ("Turks & Caicos", "🇹🇨", "+1-649", (4, 3, 6, 13)),
    ("United States", "🇺🇸", "+1", (1, 3, 7, 11)),

    # 🌍 SOUTH AMERICA (12 countries)
    ("Argentina", "🇦🇷", "+54", (2, 3, 7, 12)),
    ("Bolivia", "🇧🇴", "+591", (3, 3, 6, 12)),
    ("Brazil", "🇧🇷", "+55", (2, 3, 8, 13)),
    ("Chile", "🇨🇱", "+56", (2, 3, 7, 12)),
    ("Colombia", "🇨🇴", "+57", (2, 3, 7, 12)),
    ("Ecuador", "🇪🇨", "+593", (3, 3, 6, 12)),
    ("Guyana", "🇬🇾", "+592", (3, 3, 6, 12)),
    ("Paraguay", "🇵🇾", "+595", (3, 3, 6, 12)),
    ("Peru", "🇵🇪", "+51", (2, 3, 7, 12)),
    ("Suriname", "🇸🇷", "+597", (3, 3, 6, 12)),
    ("Uruguay", "🇺🇾", "+598", (3, 3, 6, 12)),
    ("Venezuela", "🇻🇪", "+58", (2, 3, 7, 12)),

    # 🌍 ASIA (44 countries)
    ("Afghanistan", "🇦🇫", "+93", (2, 3, 6, 11)),
    ("Armenia", "🇦🇲", "+374", (3, 3, 6, 12)),
    ("Azerbaijan", "🇦🇿", "+994", (3, 3, 6, 12)),
    ("Bahrain", "🇧🇭", "+973", (3, 3, 6, 12)),
    ("Bangladesh", "🇧🇩", "+880", (3, 3, 7, 13)),
    ("Bhutan", "🇧🇹", "+975", (3, 3, 6, 12)),
    ("Brunei", "🇧🇳", "+673", (3, 3, 6, 12)),
    ("Cambodia", "🇰🇭", "+855", (3, 3, 6, 12)),
    ("China", "🇨🇳", "+86", (2, 3, 8, 13)),
    ("Cyprus", "🇨🇾", "+357", (3, 3, 6, 12)),
    ("East Timor", "🇹🇱", "+670", (3, 3, 6, 12)),
    ("Georgia", "🇬🇪", "+995", (3, 3, 6, 12)),
    ("Hong Kong", "🇭🇰", "+852", (3, 3, 6, 12)),
    ("India", "🇮🇳", "+91", (2, 3, 7, 12)),
    ("Indonesia", "🇮🇩", "+62", (2, 3, 7, 12)),
    ("Iran", "🇮🇷", "+98", (2, 3, 7, 12)),
    ("Iraq", "🇮🇶", "+964", (3, 3, 6, 12)),
    ("Israel", "🇮🇱", "+972", (3, 3, 6, 12)),
    ("Japan", "🇯🇵", "+81", (2, 3, 7, 12)),
    ("Jordan", "🇯🇴", "+962", (3, 3, 6, 12)),
    ("Kazakhstan", "🇰🇿", "+7", (1, 3, 7, 11)),
    ("Kuwait", "🇰🇼", "+965", (3, 3, 6, 12)),
    ("Kyrgyzstan", "🇰🇬", "+996", (3, 3, 6, 12)),
    ("Laos", "🇱🇦", "+856", (3, 3, 6, 12)),
    ("Lebanon", "🇱🇧", "+961", (3, 3, 6, 12)),
    ("Macau", "🇲🇴", "+853", (3, 3, 6, 12)),
    ("Malaysia", "🇲🇾", "+60", (2, 3, 7, 12)),
    ("Maldives", "🇲🇻", "+960", (3, 3, 6, 12)),
    ("Mongolia", "🇲🇳", "+976", (3, 3, 6, 12)),
    ("Myanmar", "🇲🇲", "+95", (2, 3, 7, 12)),
    ("Nepal", "🇳🇵", "+977", (3, 3, 6, 12)),
    ("North Korea", "🇰🇵", "+850", (3, 3, 6, 12)),
    ("Oman", "🇴🇲", "+968", (3, 3, 6, 12)),
    ("Pakistan", "🇵🇰", "+92", (2, 3, 7, 12)),
    ("Palestine", "🇵🇸", "+970", (3, 3, 6, 12)),
    ("Philippines", "🇵🇭", "+63", (2, 3, 7, 12)),
    ("Qatar", "🇶🇦", "+974", (3, 3, 6, 12)),
    ("Saudi Arabia", "🇸🇦", "+966", (3, 3, 7, 13)),
    ("Singapore", "🇸🇬", "+65", (2, 3, 7, 12)),
    ("South Korea", "🇰🇷", "+82", (2, 3, 7, 12)),
    ("Sri Lanka", "🇱🇰", "+94", (2, 3, 7, 12)),
    ("Syria", "🇸🇾", "+963", (3, 3, 6, 12)),
    ("Taiwan", "🇹🇼", "+886", (3, 3, 6, 12)),
    ("Tajikistan", "🇹🇯", "+992", (3, 3, 6, 12)),
    ("Thailand", "🇹🇭", "+66", (2, 3, 7, 12)),
    ("Turkey", "🇹🇷", "+90", (2, 3, 7, 12)),
    ("Turkmenistan", "🇹🇲", "+993", (3, 3, 6, 12)),
    ("UAE", "🇦🇪", "+971", (3, 3, 6, 12)),
    ("Uzbekistan", "🇺🇿", "+998", (3, 3, 6, 12)),
    ("Vietnam", "🇻🇳", "+84", (2, 3, 7, 12)),
    ("Yemen", "🇾🇪", "+967", (3, 3, 6, 12)),

    # 🌍 EUROPE (47 countries)
    ("Albania", "🇦🇱", "+355", (3, 3, 6, 12)),
    ("Andorra", "🇦🇩", "+376", (3, 3, 6, 12)),
    ("Austria", "🇦🇹", "+43", (2, 3, 7, 12)),
    ("Belarus", "🇧🇾", "+375", (3, 3, 6, 12)),
    ("Belgium", "🇧🇪", "+32", (2, 3, 7, 12)),
    ("Bosnia", "🇧🇦", "+387", (3, 3, 6, 12)),
    ("Bulgaria", "🇧🇬", "+359", (3, 3, 6, 12)),
    ("Croatia", "🇭🇷", "+385", (3, 3, 6, 12)),
    ("Czech Rep.", "🇨🇿", "+420", (3, 3, 6, 12)),
    ("Denmark", "🇩🇰", "+45", (2, 3, 7, 12)),
    ("Estonia", "🇪🇪", "+372", (3, 3, 6, 12)),
    ("Finland", "🇫🇮", "+358", (3, 3, 6, 12)),
    ("France", "🇫🇷", "+33", (2, 3, 7, 12)),
    ("Germany", "🇩🇪", "+49", (2, 3, 7, 12)),
    ("Greece", "🇬🇷", "+30", (2, 3, 7, 12)),
    ("Hungary", "🇭🇺", "+36", (2, 3, 7, 12)),
    ("Iceland", "🇮🇸", "+354", (3, 3, 6, 12)),
    ("Ireland", "🇮🇪", "+353", (3, 3, 6, 12)),
    ("Italy", "🇮🇹", "+39", (2, 3, 7, 12)),
    ("Kosovo", "🇽🇰", "+383", (3, 3, 6, 12)),
    ("Latvia", "🇱🇻", "+371", (3, 3, 6, 12)),
    ("Liechtenstein", "🇱🇮", "+423", (3, 3, 6, 12)),
    ("Lithuania", "🇱🇹", "+370", (3, 3, 6, 12)),
    ("Luxembourg", "🇱🇺", "+352", (3, 3, 6, 12)),
    ("Malta", "🇲🇹", "+356", (3, 3, 6, 12)),
    ("Moldova", "🇲🇩", "+373", (3, 3, 6, 12)),
    ("Monaco", "🇲🇨", "+377", (3, 3, 6, 12)),
    ("Montenegro", "🇲🇪", "+382", (3, 3, 6, 12)),
    ("Netherlands", "🇳🇱", "+31", (2, 3, 7, 12)),
    ("North Macedonia", "🇲🇰", "+389", (3, 3, 6, 12)),
    ("Norway", "🇳🇴", "+47", (2, 3, 7, 12)),
    ("Poland", "🇵🇱", "+48", (2, 3, 7, 12)),
    ("Portugal", "🇵🇹", "+351", (3, 3, 6, 12)),
    ("Romania", "🇷🇴", "+40", (2, 3, 7, 12)),
    ("Russia", "🇷🇺", "+7", (1, 3, 7, 11)),
    ("San Marino", "🇸🇲", "+378", (3, 3, 6, 12)),
    ("Serbia", "🇷🇸", "+381", (3, 3, 6, 12)),
    ("Slovakia", "🇸🇰", "+421", (3, 3, 6, 12)),
    ("Slovenia", "🇸🇮", "+386", (3, 3, 6, 12)),
    ("Spain", "🇪🇸", "+34", (2, 3, 7, 12)),
    ("Sweden", "🇸🇪", "+46", (2, 3, 7, 12)),
    ("Switzerland", "🇨🇭", "+41", (2, 3, 7, 12)),
    ("Ukraine", "🇺🇦", "+380", (3, 3, 6, 12)),
    ("United Kingdom", "🇬🇧", "+44", (2, 4, 6, 12)),
    ("Vatican City", "🇻🇦", "+379", (3, 3, 6, 12)),

    # 🌍 OCEANIA (14 countries)
    ("Australia", "🇦🇺", "+61", (2, 3, 7, 12)),
    ("Fiji", "🇫🇯", "+679", (3, 3, 6, 12)),
    ("Kiribati", "🇰🇮", "+686", (3, 3, 6, 12)),
    ("Marshall Is.", "🇲🇭", "+692", (3, 3, 6, 12)),
    ("Micronesia", "🇫🇲", "+691", (3, 3, 6, 12)),
    ("Nauru", "🇳🇷", "+674", (3, 3, 6, 12)),
    ("New Zealand", "🇳🇿", "+64", (2, 3, 7, 12)),
    ("Palau", "🇵🇼", "+680", (3, 3, 6, 12)),
    ("Papua New Guinea", "🇵🇬", "+675", (3, 3, 6, 12)),
    ("Samoa", "🇼🇸", "+685", (3, 3, 6, 12)),
    ("Solomon Is.", "🇸🇧", "+677", (3, 3, 6, 12)),
    ("Tonga", "🇹🇴", "+676", (3, 3, 6, 12)),
    ("Tuvalu", "🇹🇻", "+688", (3, 3, 6, 12)),
    ("Vanuatu", "🇻🇺", "+678", (3, 3, 6, 12)),

    # 🌍 MICRO / SPECIAL
    ("Hawaii", "🌺", "+1-808", (4, 3, 6, 13)),
    ("Guam", "🇬🇺", "+1-671", (4, 3, 6, 13)),
    ("American Samoa", "🇦🇸", "+1-684", (4, 3, 6, 13)),
    ("Northern Mariana", "🇲🇵", "+1-670", (4, 3, 6, 13)),
]
...
def save_number_to_db(user_id, country_name, flag, dial_code, phone_number, display):
    conn = sqlite3.connect(DB_FILE); c = conn.cursor()
    c.execute("INSERT INTO assigned_numbers (user_id, country, flag, dial_code, phone_number, full_display, created_at) VALUES (?,?,?,?,?,?,?)",
              (user_id, country_name, flag, dial_code, phone_number, display, datetime.now().isoformat()))
    conn.commit(); number_id = c.lastrowid; conn.close()
    return number_id

def get_user_numbers(user_id):
    conn = sqlite3.connect(DB_FILE); c = conn.cursor()
    c.execute("SELECT id, country, flag, dial_code, phone_number, full_display, created_at FROM assigned_numbers WHERE user_id=? AND status='active' ORDER BY id DESC", (user_id,))
...
COUNTRY_TO_SHELEX = {
    ...
    "New Zealand": "nz", "Hong Kong": "hk", "Taiwan": "tw", "Singapore": "sg",
    "Malaysia": "my", "Kazakhstan": "kz", "Qatar": "qa", "Kuwait": "kw",
                        ...
                        for msg in otp_data:
                            if isinstance(msg, dict):
                                ...
                                if not exists:
                                    ...
                                    for svc in ["whatsapp","facebook","instagram","tiktok","telegram",
                                    ...
                                    if user_row and bot_app:
                                        user_id = user_row[0]
                                        async def notify():
                                            try: await bot_app.bot.send_message(chat_id=user_id, text=f"📥 **New OTP!**\n\n📞 `{phone}`\n🏷️ {service}\n🔑 `{otp_code}`\n\nCheck Inbox!", parse_mode="Markdown")
                                            except: pass
...
# Get Render URL from environment or config — defaults to cyberx_otp.onrender.com
...
def twilio_webhook():
    ...
    if row:
        ...
        service = "SMS"
        for svc in ["whatsapp","facebook","instagram","tiktok","telegram","google","twitter","snapchat","linkedin","discord","amazon","paypal","uber","airbnb","netflix","microsoft","apple","spotify","signal","wechat"]:
...
def start_flask():
    port = int(os.environ.get("PORT", 10000))  # PORT 10000
    flask_app.run(host="0.0.0.0", port=port, debug=False, use_reloader=False)

# ================================================================
# 🤖 HEALTH PING — KEEPS RENDER AWAKE (Every 4 minutes)
# ================================================================
...
def health_ping():
    ...
    # Try env variable first, default to cyberx_otp.onrender.com
    render_url = os.environ.get("RENDER_EXTERNAL_URL", "https://cyberx_otp.onrender.com")
    
    # If not set via env, check config DB
    if not render_url:
        try:
            conn = sqlite3.connect(DB_FILE); c = conn.cursor()
            c.execute("SELECT value FROM config WHERE key='render_url'")
            row = c.fetchone()
            if row: render_url = row[0]
            conn.close()
        except: pass
    
    if not render_url:
        print("[HEALTH] No Render URL configured. Using cyberx_otp.onrender.com")
        render_url = "https://cyberx_otp.onrender.com"
    
    while True:
        try:
            resp = requests.get(f"{render_url}/health", timeout=30)
            print(f"[HEALTH] ✅ Pinged {render_url}/health → {resp.status_code} | {datetime.now().strftime('%H:%M:%S')}")
        except Exception as e:
            print(f"[HEALTH] Ping failed: {e}")
        time.sleep(240)  # 4 minutes

# ================================================================
# 🕵️ SERVICE DETECTION — Detect if number is registered on an app
# ================================================================

# Known ranges that certain apps use (sample data for educational demo)
SERVICE_PREFIXES = {
    "WhatsApp": [f"+1{random.choice('23456789')}{random.choice('0123456789')}{random.choice('0123456789')}" for _ in range(5)],
}

def check_service_registration(phone_number):
    """
    Check if a phone number appears to be registered with known services.
    Uses Shelex API to detect if the number has received messages from specific services.
    Returns a list of services the number is registered on.
    """
    registered_services = []
    try:
        ...
        # Try Shelex to see if this number has any messages
        for country_code in ["us", "gb", "in", "ca", "au"]:
            try:
                resp = requests.get(f"https://otp-api.shelex.dev/api/{country_code}/{clean_phone}", timeout=5)
                if resp.status_code == 200:
                    data = resp.json()
                    if data and isinstance(data, list):
                        for msg in data:
                            if isinstance(msg, dict):
                                msg_text = msg.get("message", msg.get("sms", msg.get("text", ""))).lower()
                                for svc in ["whatsapp", "facebook", "instagram", "tiktok", "telegram",
                                            "google", "twitter", "snapchat", "linkedin", "discord",
                                            "amazon", "paypal", "uber", "airbnb", "netflix",
                                            "microsoft", "apple", "spotify", "signal", "wechat"]:
                                    if svc in msg_text and svc.upper() not in registered_services:
                                        registered_services.append(svc.upper())
            except:
                continue
...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await update.message.reply_text(
        ...
        f"**FREE OTPs:** Shelex auto-polling (30s)\n"
        f"**REAL OTPs:** Twilio webhook\n"
        f"**HOSTED ON:** Render (free)\n"
        f"**PORT:** 10000\n"
        f"**URL:** https://cyberx_otp.onrender.com\n\n"
...
async def button_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if data == "main_menu":
        ...
        if idx < len(COUNTRIES):
            ...
            # Check if number is already registered on services
            services = check_service_registration(phone)
            service_info = ""
            if services:
                service_info = f"\n\n⚠️ **This number appears to be registered on:**\n"
                for s in services[:5]:
                    service_info += f"   • {s}\n"
                service_info += f"\n_Another user may have used this number before_"
        ...
        if not nums:
            await safe_edit(query, "📭 **No active numbers**\nPress 📱 **Get Number** to start!",
                           parse_mode="Markdown", reply_markup=build_main_keyboard())
            return
        keyboard = []
        for n in nums[:10]:
            nid, country, flag, dial, phone, display, created = n
            mc = get_number_messages_count(nid); keyboard.append([InlineKeyboardButton(f"{flag} {country}: {display} (📩{mc})", callback_data=f"view_number_{nid}")])
        ...
        for m in msgs:
            ...
            icon = "🌐" if source=="shelex_free" else "📡" if source=="twilio" else "💉"
        ...
        await safe_edit(query,
            ...
            f"**REAL OTPs:** Twilio → this webhook URL\n"
            f"**Countries:** {len(COUNTRIES)}\n\n"
            f"**No tunnels, no domains, no bullshit.**\n"
            f"Just paste the webhook URL in Twilio.",
            parse_mode="Markdown", reply_markup=build_main_keyboard())
        ...
        await safe_edit(query,
            ...
            "3. Set webhook to:\n"
            f"   `https://cyberx_otp.onrender.com/twilio-sms`\n"
...
async def text_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if text == "/getnumber" or text == "📱 Get Number":
        keyboard, tp = get_country_keyboard(0)
    ...
    if matching:
        if len(matching) == 1:
            ...
            # Check if registered on services
            services = check_service_registration(phone)
            svc_info = ""
            if services:
                svc_info = f"\n⚠️ Registered on: {', '.join(services[:3])}"
            ...
            return
    await update.message.reply_text("Type a country name or use buttons!", reply_markup=build_main_keyboard())

async def seturl_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    """Admin command to manually set Render URL — /seturl https://yourapp.onrender.com"""
    if update.effective_user.id != ADMIN_ID: return
    if not context.args:
        await update.message.reply_text("Usage: `/seturl https://cyberx_otp.onrender.com`", parse_mode="Markdown")
        return
...
async def inject_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        msg_id, total = save_otp_message(num_id, phone, country, service, f"Your {service} code: {code}", code, service, "manual_inject")
...
def main():
    ...
    if render_url:
        ...
        print("[!] No RENDER_EXTERNAL_URL set. Using cyberx_otp.onrender.com")
    
    # Start Flask (for webhook + health)
    flask_thread = threading.Thread(target=start_flask, daemon=True)
    flask_thread.start()
    print(f"[✓] Flask running on port 10000")
